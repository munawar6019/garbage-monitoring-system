...
@Component({
  selector: 'app-your-cleaned-dustbin',
  templateUrl: './your-cleaned-dustbin.component.html',
  styleUrls: ['./your-cleaned-dustbin.component.css']
})
export class YourCleanedDustbinComponent  implements OnInit{
  list: Dustbin[];
  count: any;
