...
@Component({
  selector: 'app-notify-pending-supervisor',
  templateUrl: './notify-pending-supervisor.component.html',
  styleUrls: ['./notify-pending-supervisor.component.css']
})
export class NotifyPendingSupervisorComponent{
  list: User[];
  count: any;
  ...
  ngOnInit() {
    this.userService.getPendingSupervisor().subscribe(actionArray =>{
